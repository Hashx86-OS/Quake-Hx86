...
void R_AliasTransformAndProjectFinalVerts (finalvert_t *fv, stvert_t *pstverts)
{
	...
	// projection
		...
		if (fv->v[0] < 0) fv->v[0] = 0;
		if (fv->v[1] < 0) fv->v[1] = 0;
		if (fv->v[0] >= r_refdef.vrectright) fv->v[0] = r_refdef.vrectright - 1;
		if (fv->v[1] >= r_refdef.vrectbottom) fv->v[1] = r_refdef.vrectbottom - 1;
